...
public class SectionFActivity extends AppCompatActivity {
    ...
    private void SaveDraft() throws JSONException {
        ...
        f1.put("f101",
                bi.f101a.isChecked() ? "1" :
                        bi.f101b.isChecked() ? "2" :
                                "0");
        ...
        f1.put("f111",
                bi.f111a.isChecked() ? "1" :
                        bi.f111b.isChecked() ? "2" :
                                "0");

        f1.put("f112",
                bi.f112a.isChecked() ? "1" :
                        bi.f112b.isChecked() ? "2" :
                                bi.f112c.isChecked() ? "98" :
                                        "0");

        f1.put("f113",
                bi.f113a.isChecked() ? "1" :
                        bi.f113b.isChecked() ? "98" :
                                "0");
        f1.put("f113ax", bi.f113ax.getText().toString());

        f1.put("f114",
                bi.f114a.isChecked() ? "1" :
                        bi.f114b.isChecked() ? "2" :
                                "0");

        f1.put("f115",
                bi.f115a.isChecked() ? "1" :
                        bi.f115b.isChecked() ? "2" :
                                bi.f115c.isChecked() ? "3" :
                                        bi.f115d.isChecked() ? "4" :
                                                bi.f115e.isChecked() ? "5" :
                                                        bi.f115f.isChecked() ? "6" :
                                                                "0");
        ...
        f1.put("f117",
                bi.f117a.isChecked() ? "1" :
                        bi.f117b.isChecked() ? "2" :
                                bi.f117c.isChecked() ? "3" :
                                        bi.f117d.isChecked() ? "4" :
                                                bi.f117e.isChecked() ? "5" :
                                                        "0");

        f1.put("f118",
                bi.f118a.isChecked() ? "1" :
                        bi.f118b.isChecked() ? "2" :
                                "0");
        f1.put("f118ax", bi.f118ax.getText().toString());
        f1.put("f118bx", bi.f118bx.getText().toString());

        f1.put("f119",
                bi.f119a.isChecked() ? "1" :
