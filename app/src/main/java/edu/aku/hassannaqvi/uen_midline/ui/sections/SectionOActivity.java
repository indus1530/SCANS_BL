...
public class SectionOActivity extends AppCompatActivity {
    ...
    private void SaveDraft() throws JSONException {
                        ...
                        bi.o101b.isChecked() ? "2" :
                                bi.o101c.isChecked() ? "3" :
                                        bi.o10196.isChecked() ? "96" :
                                                "0");
        o1.put("o10196x", bi.o10196x.getText().toString());
        ...
        o1.put("o104a", bi.o104a.isChecked() ? "1" : "0");
        o1.put("o104b", bi.o104b.isChecked() ? "2" : "0");
        o1.put("o104c", bi.o104c.isChecked() ? "3" : "0");
        o1.put("o104d", bi.o104d.isChecked() ? "4" : "0");
        o1.put("o10496", bi.o10496.isChecked() ? "96" : "0");
        o1.put("o10496x", bi.o10496x.getText().toString());

        o1.put("o105a", bi.o105a.isChecked() ? "1" : "0");
        o1.put("o105b", bi.o105b.isChecked() ? "2" : "0");
        ...
        o1.put("o107a", bi.o107a.isChecked() ? "1" : "0");
        o1.put("o107b", bi.o107b.isChecked() ? "2" : "0");
        o1.put("o107c", bi.o107c.isChecked() ? "3" : "0");
        o1.put("o107d", bi.o107d.isChecked() ? "4" : "0");
                                                ...
                                                bi.o108e.isChecked() ? "5" :
                                                        bi.o108f.isChecked() ? "6" :
                                                                bi.o108g.isChecked() ? "7" :
                                                                        bi.o10896.isChecked() ? "96" :
                                                                                "0");
        o1.put("o10896x", bi.o10896x.getText().toString());
