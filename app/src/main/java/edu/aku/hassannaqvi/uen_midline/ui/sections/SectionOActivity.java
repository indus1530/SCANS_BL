...
public class SectionOActivity extends AppCompatActivity {
    ...
    private void SaveDraft() throws JSONException {
        ...
        json.put("o101", bi.o101a.isChecked() ? "1" :
                        bi.o101b.isChecked() ?"2" :
                                bi.o101c.isChecked() ? "3" :
                                        bi.o10196.isChecked() ? "96" : "0");
        json.put("o10196x", bi.o10196x.getText().toString());

        json.put("o102", bi.o102a.isChecked() ? "1" :
                bi.o102b.isChecked() ? "2" : "0");

        json.put("o103", bi.o103a.isChecked() ? "1" :
                bi.o103b.isChecked() ? "2" : "0");
        ...
        json.put("o105", bi.o105a.isChecked() ? "1" :
                bi.o105b.isChecked() ? "2" : "0");

        json.put("o106", bi.o106a.isChecked() ? "1" :
                bi.o106b.isChecked() ? "2" : "0");
                                                ...
                                                bi.o108e.isChecked() ? "5" :
                                                        bi.o108f.isChecked() ? "6" :
                                                                bi.o108g.isChecked() ? "7" :
                                                                        bi.o10896.isChecked() ? "96" : "0");
        json.put("o10896x", bi.o10896x.getText().toString());
