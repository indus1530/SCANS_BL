...
public class SectionNActivity extends AppCompatActivity {
    ...
    private void SaveDraft() throws JSONException {
        ...
        n1.put("n104",
                bi.n104a.isChecked() ? "1" :
                        bi.n104b.isChecked() ? "98" :
                                "0");
        n1.put("n104ax", bi.n104ax.getText().toString());
        ...
        n1.put("n109a", bi.n109a.isChecked() ? "1" : "0");
        n1.put("n109b", bi.n109b.isChecked() ? "2" : "0");
        n1.put("n109c", bi.n109c.isChecked() ? "3" : "0");
        n1.put("n109d", bi.n109d.isChecked() ? "4" : "0");
        n1.put("n109e", bi.n109e.isChecked() ? "5" : "0");
        n1.put("n109f", bi.n109f.isChecked() ? "6" : "0");
        n1.put("n109g", bi.n109g.isChecked() ? "7" : "0");
